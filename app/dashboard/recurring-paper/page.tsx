...
/**
 * `/dashboard/recurring-paper` — Phase 5.2 parity route.
 *
 * Reachable at all times so the Swiss and Paper views can be compared
 * side-by-side during the migration; `/dashboard/recurring` picks the
 * branch at render time based on `NEXT_PUBLIC_PAPER_UI`. Once Phase 9
 * deletes Swiss, this route inlines into `/dashboard/recurring`.
 */
export default async function RecurringPaperPage() {
