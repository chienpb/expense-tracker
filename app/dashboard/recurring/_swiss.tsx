...
/**
 * Swiss `/dashboard/recurring` — preserved verbatim for the Phase 5.2
 * flag-off fallback. Deleted with the Swiss sweep in Phase 9.
 */
export async function SwissRecurringPage() {
