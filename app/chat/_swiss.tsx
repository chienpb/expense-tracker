...
/**
 * Swiss chat surface — preserved verbatim from the pre-Phase-5.3 page.
 * Active when `NEXT_PUBLIC_PAPER_UI` is unset/0. Remove in Phase 9
 * when the feature flag collapses.
 */
export function SwissChatPage() {
